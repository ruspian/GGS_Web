...
const AddAnggotaAdminComponent = ({ isAddModalOpen, handleCancelAdd, onAddSuccess }) => {
      ...
      >
        ...
        >
          <Form.Item
            name="name"
            label="Nama"
            rules={[{ required: true, message: 'Mohon masukkan nama kegiatan!' }]}
          >
          ...
          <Form.Item
            name="tempat_lahir"
            label="Tempat Lahir"
            rules={[{ required: true, message: 'Mohon masukkan tempat lahit!' }]}
          >
          ...
          <Form.Item
            ...
            rules={[{ required: true, message: 'Mohon masukkan alamat lengkap!' }]}
          >
            <TextArea
          ...
          <Form.Item
            ...
            label="Akun X"
          >
            <Input placeholder='Akun X' />
          </Form.Item>

          <Form.Item
            label="Foto Profil"
            rules={[{
              validator: () => (fileList.length > 0 ? Promise.resolve() : Promise.reject('Mohon unggah foto Anda!')),
            }]}
          >
            <Upload
...
export default AddAnggotaAdminComponent
